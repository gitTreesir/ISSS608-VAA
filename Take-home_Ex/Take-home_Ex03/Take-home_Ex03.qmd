...
There were also a number of data quality issues that hindered the data analysis. For example:

[Node Records]{.underline}

-   Unclean Data comprises of missing values (`NA`), `unknown` and `character(0)` in `revenue_omu` and `product_services` fields.
