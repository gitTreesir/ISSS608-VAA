...
In this hands-on exercise, we will model, analyse and visualise network data using R.
...
-   *GAStech-email_edges.csv* which consists of two weeks of 9063 emails correspondances between 55 employees.
    ...
    ![](images/01_edges.jpg){fig-align="center"}

### 3.2. The Nodes data

-   *GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

![](images/02_nodes.jpg){fig-align="center"}
...
![](images/03_activate.jpg){fig-align="center"}
...
::: callout-note
Recommended to look at the reference guide of [`tbl_graph()`](https://tidygraph.data-imaginist.com/reference/tbl_graph.html)
:::
...
![](images/04_ggraph_layouts.jpg){fig-align="center"} ![](images/05_ggraph_layouts2.jpg){fig-align="center"}
...
::: callout-note
Visit [Option](http://datastorm-open.github.io/visNetwork/options.html) to find out more about visEdges's argument.
:::
